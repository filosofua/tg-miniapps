...
const decodeSvg = (dataUri) => {
  ...
  try {
    ...
    console.warn('Не удалось декодировать SVG', error);
    return '';
  }
};
...
const App = ({ bootstrap = {} }) => {
  ...
  const finalSvgMarkup = useMemo(() => decodeSvg(state.nftFinal?.image), [state.nftFinal]);
          ...
          <div className="shell-card" style={{ marginTop: 12 }}>
            ...
            <div className="nft">
              <div className="nft-visual">
                ...
                {finalSvgMarkup && (
                  <div className="nft-inline" dangerouslySetInnerHTML={{ __html: finalSvgMarkup }} />
                )}
              </div>
