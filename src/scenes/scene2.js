...
const scene2 = {
  ...
  steps: [
    ...
    {
      type: "choice",
      text: "Следующий шаг — поговорить с семьёй. Как подашь им новости?",
      options: [
        {
          label: "Мягко: 'Мы проверяем каждый след, расскажите о Дэнни'",
          minPoints: 2,
          maxPoints: 5,
          nextScene: 3
        },
        {
          label: "Прямо: 'Он ходил к старому заводу. Вы знали?'",
          minPoints: 2,
          maxPoints: 5,
          nextScene: 3
        }
