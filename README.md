...
## Подбор ассетов
В репозитории добавлен файл `ASSET_PROMPTS.md` с готовыми промтами для генерации фонов, NFT-детективов, финальных NFT и UI-элементов в стилистике dark retro comic noir. Он помогает быстро собрать пак картинок, сохраняя единый стиль и совместимость с текущими путями ассетов (`public/assets/...`).
